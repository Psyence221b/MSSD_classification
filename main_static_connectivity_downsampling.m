...
for nSubj = 1:size(BasicInfo,1)
    ...
    TMP_Data_areas = [Flip_Data_mPFC Flip_Data_BLA Flip_Data_Amyg Flip_Data_calcarine Flip_Data_postcentral];
    ...
    clear File_BLA File_mPFC File_whole formatSpec fileID Flip_data*
...
%% Make Output Table
ResultTable_sFC      = addvars(BasicInfo, mPFC_BLA, mPFC_Amyg, mPFC_calcarine, mPFC_postcentral, Amyg_BLA, Amyg_calcarine, Amyg_postcentral);
...
%% Save Results
cd(Dirdata); cd('..');
mkdir('Result_sFC_downsampling');
cd('Result_sFC_downsampling');
