...
for nSubj = 1:size(BasicInfo,1)
    ...
    File_V1 = dir('*juelich*V1*'); File_V1 = File_V1.name;
    File_A1 = dir('*juelich*auditory*'); File_A1 = File_A1.name;
    File_M1 = dir('*juelich*motor*'); File_M1 = File_M1.name;
...
%% Save Results
cd(Dirdata); cd('..');
mkdir('Result_MSSD_ROIcontrol_v3');
cd('Result_MSSD_ROIcontrol_v3');
